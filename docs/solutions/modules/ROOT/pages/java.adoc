...
image::images:solutions:ROOT:jenkins-maven-step.png['Jenkins Maven step', role=center]
...
image::images:ROOT:solution-images:jenkins-gradle-step.png['Jenkins Gradle step', role=center]
