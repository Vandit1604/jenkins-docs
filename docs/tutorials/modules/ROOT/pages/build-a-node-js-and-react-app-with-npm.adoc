...
:page-aliases: building-a-node-js-and-react-app-with-npm.adoc, using-jenkins-to-build-a-node-js-and-react-application-with-npm.adoc, using-jenkins-to-build-a-node-js-react-project.adoc
