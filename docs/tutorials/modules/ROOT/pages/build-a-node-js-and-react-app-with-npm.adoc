...
xref:user-docs:installing-jenkins:_partials$_setup-wizard-for-tutorials.adoc[run Jenkins in Docker] and then
proceed on.

include::partial$_prerequisites[prerequisites].adoc[]
...
'''
++++
include::docs/partial/_feedback-footer.html[]
++++
