...
:page-aliases: :building-a-node-js-and-react-app-with-npm.adoc
:page-aliases: :using-jenkins-to-build-a-node-js-and-react-application-with-npm.adoc
:page-aliases: :using-jenkins-to-build-a-node-js-react-project.adoc
...
xref:user-docs:installing-jenkins:partial$_run-jenkins-in-docker.adoc[run Jenkins in Docker] from xref:tutorials:ROOT:index.adoc[another tutorial].

You can stop this tutorial at any point in time and continue from where you left
off.

If you've already run though xref:tutorials:ROOT:index.adoc[another tutorial], you can skip the
include::partial$_prerequisites[prerequisites] and <<run-jenkins-in-docker,Run Jenkins in
Docker>> sections below and proceed on to xref:partial$_fork-sample-repository.adoc[forking the
...
xref:user-docs:installing-jenkins:partials_setup-wizard-for-tutorials.adoc[run Jenkins in Docker] and then
proceed on.
...
+
[.boxshadow]
image:node-js-react-01-downloading-node-docker-image.png[alt="Downloading
...
+
[.boxshadow]
image:node-js-react-02-initial-pipeline-downloading-npm-dependencies.png[alt="Downloading
...
[.boxshadow]
image:node-js-react-03-initial-pipeline-runs-successfully.png[alt="Initial
Pipeline runs successfully",width=100%]
. Click the *X* at the top-right to return to the main Blue Ocean interface.
+
[.boxshadow]
image:node-js-react-04-main-blue-ocean-interface.png[alt="Main Blue
...
[.boxshadow]
image:node-js-react-11-test-stage-runs-successfully-with-output.png[alt="Test
...
+
[.boxshadow]
image:node-js-react-21-deliver-stage-pauses-for-user-input.png[alt="Deliver
...
[.boxshadow]
image:node-js-react-22-deliver-stage-opened-deliver-sh-step.png[alt="Deliver
...
+
[.boxshadow]
image:node-js-react-23-deliver-stage-runs-successfully.png[alt="Deliver
stage runs successfully",width=100%]
. Click the *X* at the top-right to return to the main Blue Ocean interface,
  which lists your previous Pipeline runs in reverse chronological order.
[.boxshadow]
image:node-js-react-24-main-blue-ocean-interface-with-all-previous-runs-displayed.png[alt="Main
