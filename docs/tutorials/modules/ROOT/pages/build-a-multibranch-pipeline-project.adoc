...
one of the initial set of Introductory tutorials from the xref:tutorials:ROOT:index.adoc[Tutorials overview] page first to familiarize
...
If you've already run though xref:tutorials:ROOT:index.adoc[another tutorial], you can skip the <<prerequisites,prerequisites>> and <<run-jenkins-in-docker,Run Jenkins in
