...
If you've already run though xref:tutorials:index.adoc[another tutorial], you can skip the <<prerequisites,prerequisites>> and <<run-jenkins-in-docker,Run Jenkins in
