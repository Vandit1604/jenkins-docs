...
:page-aliases: building-a-multibranch-pipeline-project.adoc
...
one of the initial set of Introductory tutorials from the xref:tutorials:index.adoc[Tutorials overview] page first to familiarize
...
xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc[Build a Node.js and React app
...
xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc#create-your-initial-pipeline-as-a-jenkinsfile[``Create
your initial Pipeline...''] and
xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc#add-a-test-stage-to-your-pipeline[``Add
...
* For an explanation of the `input message` steps, refer to annotation *4* of
  ...
  xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc#add-a-final-deliver-stage-to-your-pipeline[``Add
