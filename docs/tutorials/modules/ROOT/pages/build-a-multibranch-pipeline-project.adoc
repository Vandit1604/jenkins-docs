...
one of the initial set of xref:tutorials:ROOT:index.adoc#introductory-tutorials[Introductory
tutorials] from the xref:tutorials:ROOT:index.adoc[Tutorials overview] page first to familiarize
...
xref:tutorials:ROOT:build-a-node-js-and-react-app-with-npm.adoc[Build a Node.js and React app
...
<<run-jenkins-in-docker,run Jenkins in Docker>> from xref:tutorials:ROOT:index.adoc[another tutorial].
...
xref:tutorials:ROOT:build-a-node-js-and-react-app-with-npm.adoc#create-your-initial-pipeline-as-a-jenkinsfile[``Create
your initial Pipeline...''] and
xref:tutorials:ROOT:build-a-node-js-and-react-app-with-npm.adoc#add-a-test-stage-to-your-pipeline[``Add
...
* For an explanation of the `input message` steps, refer to annotation *4* of
  ...
  xref:tutorials:ROOT:build-a-node-js-and-react-app-with-npm.adoc#add-a-final-deliver-stage-to-your-pipeline[``Add
