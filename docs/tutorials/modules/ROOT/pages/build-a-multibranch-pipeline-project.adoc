...
one of the initial set of Introductory tutorials from the xref:ROOT:index.adoc[Tutorials overview] page first to familiarize
...
xref:build-a-node-js-and-react-app-with-npm.adoc[Build a Node.js and React app
...
If you've already run though xref:ROOT:index.adoc[another tutorial], you can skip the <<prerequisites,prerequisites>> and <<run-jenkins-in-docker,Run Jenkins in
...
xref:build-a-node-js-and-react-app-with-npm.adoc#create-your-initial-pipeline-as-a-jenkinsfile[``Create
your initial Pipeline...''] and
xref:build-a-node-js-and-react-app-with-npm.adoc#add-a-test-stage-to-your-pipeline[``Add
...
* For an explanation of the `input message` steps, refer to annotation *4* of
  ...
  xref:build-a-node-js-and-react-app-with-npm.adoc#add-a-final-deliver-stage-to-your-pipeline[``Add
