...
The exact duration depends on the speed of your machine and whether or not you've already xref:tutorials:ROOT:create-a-pipeline-in-blue-ocean.adoc#run-jenkins-in-docker[run Jenkins in Docker] from xref:ROOT:index[another tutorial].
