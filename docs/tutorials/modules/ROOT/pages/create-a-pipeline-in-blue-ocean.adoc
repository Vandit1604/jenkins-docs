...
:page-aliases: creating-a-pipeline-in-blue-ocean.adoc
...
Before you start this tutorial, be sure to run through at least one of the initial tutorials from the xref:tutorials:ROOT:index.adoc[tutorials overview] page.
...
This tutorial uses the same application that the xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc[build a Node.js and React app with npm] tutorial is based on.
...
The exact duration depends on the speed of your machine and whether or not you've already xref:user-docs:installing-jenkins:partial$_run-jenkins-in-docker.adoc[run Jenkins in Docker] from xref:tutorials:ROOT:index.adoc[another tutorial].
...
If you've already run though xref:tutorials:ROOT:index.adoc[another tutorial], you can skip the <<prerequisites,prerequisites>> and xref:user-docs:installing-jenkins:partial$_run-jenkins-in-docker.adoc[run Jenkins in Docker] sections below and proceed to <<fork-sample-repository,forking the sample repository>>.
If you need to restart Jenkins, follow the restart instructions in xref:user-docs:installing-jenkins:partials_setup-wizard-for-tutorials.adoc[run Jenkins in Docker] and then proceed.
...
include::partial$_fork-sample-repository.adoc[]
...
xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc#create-your-initial-pipeline-as-a-jenkinsfile["Create your initial Pipeline..."] section of the build a Node.js and React app tutorial.
...
+
NOTE: For an explanation of this step, refer to annotation *4* of the Declarative Pipeline in the xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc#create-your-initial-pipeline-as-a-jenkinsfile["Create your initial Pipeline..."] section of the build a Node.js and React app tutorial.
...
+
NOTE: For an explanation of this directive and its step, refer to annotations *1* and *3* of the Declarative Pipeline in the xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc#add-a-test-stage-to-your-pipeline["Add a test stage..." section of the Build a Node.js and React app] tutorial.
. ( _Optional_ ) Select the back arrow icon image:pipeline-in-blueocean-16a-return-from-step-icon.png[alt="Return from step icon",width=3%] in the upper left to return to the main Pipeline editor.
...
+
NOTE: For an explanation of this step, refer to annotation *4* of the Declarative Pipeline in the xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc#add-a-final-deliver-stage-to-your-pipeline["Add a final deliver stage..." section of the Build a Node.js and React app] tutorial.
...
This is also configured in the xref:tutorials:build-a-node-js-and-react-app-with-npm.adoc[build a Node.js and React app with npm] tutorial.
...
* The xref:tutorials:ROOT:index.adoc[Tutorials overview] page for other introductory tutorials.
* The xref:user-docs:ROOT:index.adoc[User Handbook] for more detailed information about using Jenkins, such as link:/doc/book/pipeline[Pipelines], link:/doc/book/pipeline/syntax[Pipeline syntax], and the xref:user-docs:blueocean:index.adoc[Blue Ocean] interface.
