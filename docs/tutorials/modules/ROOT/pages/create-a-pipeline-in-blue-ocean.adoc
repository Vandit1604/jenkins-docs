...
*Duration:* This tutorial takes 20-40 minutes to complete if you've already met the include::partial$_prerequisites[prerequisites] below.
...
include::user-docs:blueocean:partials$_blue-ocean-status.adoc[]

You can stop this tutorial at any point in time and continue from where you left
off.

If you've already run though xref:tutorials:index.adoc[another tutorial], you can skip the include::partial$_prerequisites[prerequisites] and xref:user-docs:installing-jenkins:partial$_run-jenkins-in-docker.adoc[run Jenkins in Docker] sections below and proceed to <<fork-sample-repository,forking the sample repository>>.
