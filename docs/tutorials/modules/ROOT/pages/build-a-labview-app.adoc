...
depend on the speed of your machine and whether or not you've already link:/doc/book/installing/[installed Jenkins] from xref:ROOT:index.adoc[another tutorial].
