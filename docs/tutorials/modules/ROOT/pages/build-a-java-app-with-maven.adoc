...
:page-aliases: :building-a-java-app-with-maven.adoc
:page-aliases: :using-jenkins-to-build-a-java-application-with-maven.adoc
...
already met the xref:partial$prerequisites.adoc[prerequisites] below). The exact duration will
...
xref:partial$prerequisites.adoc[prerequisites] and <<run-jenkins-in-docker,Run Jenkins in
...
xref:user-docs:installing-jenkins:partials$_setup-wizard-for-tutorials.adoc[run Jenkins in Docker] and then
proceed on.
