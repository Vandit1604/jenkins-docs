...
:page-aliases: building-a-java-app-with-maven.adoc using-jenkins-to-build-a-java-application-with-maven.adoc, using-jenkins-to-build-a-node-js-react-project.adoc
