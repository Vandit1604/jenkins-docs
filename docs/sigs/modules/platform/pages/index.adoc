...
image:images:avatars:no-image.svg[,width=30,height=30] David Currie
image:images:avatars:no-image.svg[,width=30,height=30] Devin Nusbaum
image:images:avatars:no-image.svg[,width=30,height=30] Durgadas Kamath
image:images:avatars:lnewman.jpeg[,width=30,height=30] Liam Newman\
image:images:avatars:no-image.svg[,width=30,height=30] Nicolas De Loof
image:images:avatars:no-image.svg[,width=30,height=30] Ramon Leon
image:images:avatars:no-image.svg[,width=30,height=30] Robert Sandell
image:images:avatars:no-image.svg[,width=30,height=30] Sam Van Oort
