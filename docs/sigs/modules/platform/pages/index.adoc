...
[.float-group]
--
image:images:ROOT:logos/formal/256.png1[Logo,width=192,float=right,role=float-gap]
...
See the current list of supported versions xref:user-docs:administration:requirements/java.adoc[here].
