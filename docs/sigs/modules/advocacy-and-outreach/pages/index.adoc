...
[.float-group]
--
image:images:ROOT:logos/chatterbox/256.png[Logo,180,135,float=right]
...
These meetups are not limited to xref:projects:ROOT:index.adoc/jam[Jenkins Area Meetups] or xref:projects:ROOT:index.adoc/jam[CI/CD Meetups],
...
xref:projects:ROOT:index.adoc/jam[This page] summarizes the current state of meetup operations.
