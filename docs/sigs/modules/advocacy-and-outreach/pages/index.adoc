...
== Members
.Leads
* image:{avatar}alyssat.jpg[,width=30,height=30] Alyssa Tong

* image:{avatar}markewaite.jpg[,width=30,height=30] Mark Waite

.Participants
* image:{avatar}jmMeessen.jpg[,width=30,height=30] Jean-Marc Meessen

* image:{avatar}krisstern.png[,width=30,height=30] Kris Stern
