...
[avatar]
* Leads:
image:images:avatars:no_image.svg[,width=30,height=30] Alexander Brandes
image:images:avatars:janfaracik.jpg[,width=30,height=30] Jan Faracik
image:images:avatars:uhafner.jpg[,width=30,height=30] Ullrich Hafner
image:images:avatars:timja.jpg[,width=30,height=30] Tim Jacomb
