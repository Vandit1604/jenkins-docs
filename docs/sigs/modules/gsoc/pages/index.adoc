...
The group drives the xref:projects:ROOT:index.adoc/gsoc[GSoC sub-project] within the Jenkins organization.
...
You can find more info about GSoC in Jenkins xref:projects:ROOT:index.adoc/gsoc[here].
...
* See the xref:projects:ROOT:index.adoc/gsoc[GSoC sub-project] for the list of public events
