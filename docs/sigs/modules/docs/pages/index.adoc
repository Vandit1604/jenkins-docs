...
Those solutions include SCM provider solutions (xref:solutions:ROOT:github.adoc[GitHub], link:/solutions/bitbucketserver[Bitbucket]),
programming language solutions (xref:solutions:ROOT:python.adoc[Python], link:/solutions/ruby[Ruby], link:/solutions/c[C/C++], link:/solutions/java[Java], and link:/solutions/php[PHP]),
