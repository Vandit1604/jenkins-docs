...
* Potential mentors:
  ...
  link:/blog/authors/oleg_nenashev/[Oleg Nenashev],
  Vivek Sonar
* Documentation SIG xref:sigs:docs:index.adoc#members[members] and component maintainers assist as their time allows (link:/blog/authors/halkeye/[Gavin Mogan] and Meg McRoberts)
...
[[GSoD-2020]]
* **xref:docs:gsod/2020/index.adoc[GSoD 2020]** xref:projects:other:document-jenkins-on-kubernetes.adoc[Document Jenkins on Kubernetes] by link:/blog/authors/zaycodes[Zainab Abubakar]
+
