...
A long-term support xref:#release[Release] line of Jenkins products, becoming available for downloads every 12 weeks. See link:/download/lts/[this page] for more info.
