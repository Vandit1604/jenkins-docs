...
| Jenkins 2.252+ include the external fingerprint storage API which can be consumed by plugins.
  More info: xref:projects:gsoc:2020/projects/project-ideas/external-fingerprint-storage.adoc[GSoC Project Page]
...
| Proposed as a GSoC 2019 project:
  xref:projects:gsoc:2019/project-ideas/project-ideas/ext-workspace-manager-cloud-features.adoc[Cloud Features for External Workspace Manager Plugin]
| N/A
