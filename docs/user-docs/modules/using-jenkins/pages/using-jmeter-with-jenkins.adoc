...
To learn more about Jenkins agents, refer to the xref:user-docs:using-jenkins:using-agents.adoc[using Jenkins agents] page.
...
The Jenkins docs has a page to help with the xref:user-docs:installing-jenkins:index.adoc[Jenkins installation process.].
