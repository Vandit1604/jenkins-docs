...
* *Pipeline Name* - Selecting this displays the xref:glossary:index.adoc#activity[default Activity tab].
...
* Selecting a run will bring up the xref:glossary:index.adoc#pipeline-run-details[Pipeline run details] to provide Pipeline visualization.
...
Selecting a branch brings up the xref:glossary:index.adoc#pipeline-run-details[Pipeline run details] for the latest completed or active run of that branch.
...
. The *edit* icon, represented by a icon:pencil[], opens the xref:glossary:index.adoc#pipeline-editor[Pipeline editor] for that branch.
...
Selecting a pull request in this list will bring up the xref:glossary:index.adoc#pipeline-run-details[Pipeline run details] for the latest completed or active run of that pull request.
