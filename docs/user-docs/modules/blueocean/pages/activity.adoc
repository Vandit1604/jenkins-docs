...
* *Pipeline Name* - Selecting this displays the xref:user-docs:glossary:index.adoc#activity[default Activity tab].
* *Favorites Toggle* - Selecting the favorite icon &#9734; to the right of the Pipeline name, adds a branch to the favorites list shown on the xref:./dashboard.adoc#favorites[dashboard's favorites list].
...
* Selecting a run will bring up the xref:user-docs:glossary:index.adoc#pipeline-run-details[Pipeline run details] to provide Pipeline visualization.
...
Selecting a branch brings up the xref:user-docs:glossary:index.adoc#pipeline-run-details[Pipeline run details] for the latest completed or active run of that branch.
...
. The *edit* icon, represented by a icon:pencil[], opens the xref:user-docs:glossary:index.adoc#pipeline-editor[Pipeline editor] for that branch.
. The *favorite* &#9734; icon adds a branch to your favorites list on the xref:./dashboard.adoc#favorites[dashboard].
...
Selecting a pull request in this list will bring up the xref:user-docs:glossary:index.adoc#pipeline-run-details[Pipeline run details] for the latest completed or active run of that pull request.
