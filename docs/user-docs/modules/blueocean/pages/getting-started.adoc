...
Refer to the xref:security:managing-security.adoc#authorization[Authorization] section of xref:security:managing-security.adoc[Managing Security] for more information.
...
+
[.boxshadow]
image::intro/blueocean-plugins-filtered.png[alt="Available Blue Ocean plugins after being filtered list.",width=100%]
...
Refer to the the xref:managing:plugins.adoc[Managing Plugins] page for more information.
...
NOTE: The first time you xref:blueocean:creating-pipelines.adoc[create a Pipeline in Blue Ocean] for a specific Git server, Blue Ocean prompts you for your Git credentials to allow you to create Pipelines in the repositories.
...
Read more about running Jenkins and Blue Ocean inside Docker in the xref:../../installing/#docker[Docker] section of the installing Jenkins page.
...
[.boxshadow]
image::intro/open-blue-ocean-link.png[alt="Open Blue Ocean link",width=20%]
...
* Already has existing Pipeline projects or other items present, the xref:blueocean:dashboard.adoc[Blue Ocean Dashboard] displays.
...
For more information, refer to the xref:blueocean:creating-pipelines.adoc[Creating a Pipeline] page for more information on creating a Pipeline project in Blue Ocean.
+
[.boxshadow]
...
* *Jenkins*: Selecting the Jenkins icon takes you to the xref:blueocean:dashboard.adoc[Dashboard] or reloads this page if you are already viewing it.
* *Pipelines*: This also takes you to the Dashboard.
If you are already on the Dashboard, this option reloads the page.
This button serves a different purpose when you are viewing a xref:blueocean:pipeline-run-details.adoc[Pipeline run details] page.
* *Administration*: This takes you to the *xref:managing:index.adoc[Manage Jenkins]* page of the Jenkins classic UI.
This button is not available if you do not have the *Administer* permission.
Refer to the xref:managing:security.adoc#authorization[Authorization] section of the Managing Security page for more information.
...
[.boxshadow]
image::intro/go-to-classic-icon.png[alt="Go to classic icon",width=5%]
