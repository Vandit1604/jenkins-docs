...
Read more about running Jenkins and Blue Ocean inside Docker in the xref:user-docs:installing-jenkins:docker.adoc#docker[Docker] section of the installing Jenkins page.
