...
Health icons on the Dashboard represent overall Pipeline health, whereas the health icons in the xref:user-docs:blueocean:activity.adoc#branches[Branches tab of the Activity View] represent the overall health for each branch.
