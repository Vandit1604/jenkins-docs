...
[.boxshadow]
image::dashboard/overview.png[Overview of the Blue Ocean Dashboard,role=center,width=100%]

== Navigation bar

The Dashboard includes the blue xref:getting-started:index.adoc#navigation-bar[navigation bar] along the top of the interface.
...
* *New Pipeline*: This option begins the process of xref:blueocean:creating-pipelines.adoc[creating a Pipeline].
...
Selecting an item in the Pipelines list will display that item's xref:blueocean:activity.adoc[Activity View].
...
Adding an item's specific branch to your Favorites list can be done through the item's xref:blueocean:activity.adoc[Activity View].
...
Selecting an item in the Favorites list opens the xref:blueocean:pipeline-run-details.adoc[Pipeline run details] for the latest run on the branch or PR indicated.
...
|image::icons/weather/sunny.svg[Sunny,role=center]
|*Sunny*, more than 80% of Runs passing

|image::icons/weather/partially-sunny.svg[Partially Sunny,role=center]
|*Partially Sunny*, 61% to 80% of Runs passing

|image::icons/weather/cloudy.svg[Cloudy,role=center,width=100]
|*Cloudy*, 41% to 60% of Runs passing

|image::icons/weather/raining.svg[Raining,role=center]
|*Raining*, 21% to 40% of Runs passing

|image::icons/weather/storm.svg[Storm,role=center]
...
|image::dashboard/status-in-progress.png["In Progress" Status Icon,role=center]
|*In Progress*

|image::dashboard/status-passed.png["Passed" Status Icon,role=center]
|*Passed*

|image::dashboard/status-unstable.png["Unstable" Status Icon,role=center]
|*Unstable*

|image::dashboard/status-failed.png["Failed" Status Icon,role=center]
|*Failed*

|image::dashboard/status-aborted.png["Aborted" Status Icon,role=center]
|*Aborted*
|===
