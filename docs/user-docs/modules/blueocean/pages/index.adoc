...
This chapter is intended for Jenkins users of all skill levels, but beginners may need to refer to the xref:#pipeline#[Pipeline] chapter to understand some topics covered here.

For an overview of content in the Jenkins User Handbook, refer to
xref:#getting-started#[user handbook overview].
