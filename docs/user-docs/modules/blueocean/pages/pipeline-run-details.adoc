...
. *Edit Pipeline* - Open this run's Pipeline in the xref:user-docs:glossary:index.adoc#pipeline-editor[Pipeline Editor].
...
. *Close Details* - Closes the Details view and returns the user to the xref:user-docs:glossary:index.adoc#activity[Activity view] for this Pipeline.
