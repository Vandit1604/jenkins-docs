...
. *Edit Pipeline* - Open this run's Pipeline in the xref:glossary:index.adoc#pipeline-editor[Pipeline Editor].
...
. *Close Details* - Closes the Details view and returns the user to the xref:glossary:index.adoc#activity[Activity view] for this Pipeline.
