...
xref:#../glossary#update-center[Update Center]. The Update Center is a service
...
the Jenkins web UI, to making changes on the xref:#../glossary#controller[controller's]
file system.
