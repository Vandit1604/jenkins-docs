...
image::change-system-timezone-user-defined-timezone.png["Configure option in the dropdown",role=center,width=800]

image::change-system-timezone-user-defined-timezone-2.png["Changing user defined timezone setting",role=center,width=800]
...
You can also set it from the xref:user-docs:managing:script-console.adoc[Jenkins Script Console] on a live system without the need for a restart.
