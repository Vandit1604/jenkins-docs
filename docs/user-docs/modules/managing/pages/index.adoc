...
xref:system-configuration.adoc[System]::
...
See xref:user-docs:security:index.adoc[Securing Jenkins] for general information
about managing Jenkins security.

xref:system-configuration.adoc[Security]::
...
xref:system-info.adoc[System Information]::
...
xref:about-jenkins.adoc[About Jenkins]::
