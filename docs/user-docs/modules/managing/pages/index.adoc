...
xref:#system-administration#[Jenkins System Administration].
...
xref:using-jenkins:using-credentials.adoc#adding-new-global-credentials[Manage Credentials]::
...
xref:managing:system-info[System Information]::
...
xref:managing:about-jenkins[About Jenkins]::
