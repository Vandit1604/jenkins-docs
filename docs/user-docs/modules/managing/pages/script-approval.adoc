...
* xref:user-docs:glossary:index.adoc#script-console[Script Console].
* xref:user-docs:glossary:index.adoc#pipeline[Jenkins Pipeline].
...
enabled by default for xref:user-docs:pipeline:index.adoc[Jenkins Pipeline] allowing
...
xref:user-docs:pipeline:index.adoc[Jenkins Pipelines].
