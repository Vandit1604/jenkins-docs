...
- name: hudson.model.DirectoryBrowserSupport.CSP
  ...
  description: |
    ...
    See xref:security:configuring-content-security-policy.adoc[Configuring Content Security Policy] for more details.
...
- name: hudson.remoting.ClassFilter
  ...
  description: |
    ...
    See {jep}200#backwards-compatibility[JEP-200] and https://issues.jenkins.io/browse/JENKINS-47736/README.adoc[JENKINS-47736].
