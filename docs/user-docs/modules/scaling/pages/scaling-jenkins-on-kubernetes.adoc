...
After successfully creating your Jenkins image, follow the steps explained in the xref:user-docs:installing-jenkins:kubernetes.adoc#install-jenkins-with-yaml-files[Jenkins installation doc] to deploy your Jenkins controller.
