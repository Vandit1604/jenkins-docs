...
Depending on your current Java version, there are instructions for xref:platform-information:upgrade-java-to-11/[upgrading to Java 11] and xref:platform-information:upgrade-java-to-17.adoc.adoc[upgrading to Java 17].
