...
a|The versions of Winstone and Jetty bundled in the Jenkins xref:user-docs:installing-jenkins:war-file.adoc[WAR file].
...
.References
***** xref:user-docs:installing-jenkins:servlet-containers.adoc[Installation instructions]
