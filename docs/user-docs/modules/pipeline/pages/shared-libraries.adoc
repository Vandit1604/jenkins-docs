...
image::add-global-pipeline-libraries.png["Add a Global Pipeline Library", role=center]
...
image::configure-global-pipeline-library.png["Configuring a Global Pipeline Library", role=center]
...
image::global-pipeline-library-modern-scm.png["Configuring a 'Modern SCM' for a Pipeline Library", role=center]
...
image::global-pipeline-library-legacy-scm.png["Configuring a 'Legacy SCM' for a Pipeline Library", role=center]
