...
xref:./../managing/cli.adoc#ssh[SSH interface]
to run the linter. See the xref:user-docs:glossary:index.adoc#../managing/cli[Jenkins CLI documentation] for details on how to properly configure
...
The xref:user-docs:glossary:index.adoc#../blueocean/pipeline-editor[Blue Ocean Pipeline Editor] provides a link:https://en.wikipedia.org/wiki/WYSIWYG[WYSIWYG] way to create Declarative Pipelines.
...
xref:user-docs:glossary:index.adoc#shared-libraries[Shared Library], the code from the shared library will
...
Pipelines and xref:user-docs:glossary:index.adoc#shared-libraries[Shared Libraries]
