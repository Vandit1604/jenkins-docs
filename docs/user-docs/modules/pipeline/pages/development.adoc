...
to run the linter. See the xref:glossary:index.adoc#../managing/cli[Jenkins CLI documentation] for details on how to properly configure
...
xref:glossary:index.adoc#shared-libraries[Shared Library], the code from the shared library will
...
Pipelines and xref:glossary:index.adoc#shared-libraries[Shared Libraries]
