...
In the xref:user-docs:glossary:index.adoc#jenkinsfile[previous section] a `Jenkinsfile` which could be
...
xref:user-docs:glossary:index.adoc#getting-started#global-variable-reference[Global Variable Reference].
