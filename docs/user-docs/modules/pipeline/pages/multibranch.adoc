...
In the xref:glossary:index.adoc#jenkinsfile[previous section] a `Jenkinsfile` which could be
...
xref:glossary:index.adoc#getting-started#global-variable-reference[Global Variable Reference].
