...
xref:user-docs:pipeline:getting-started.adoc[Getting started with Pipeline]
...
As discussed in the
xref:user-docs:pipeline:getting-started.adoc#defining-a-pipeline-in-scm[Defining a Pipeline in SCM],
...
Credentials
xref:user-docs:using-jenkins:using-credentials.adoc#configuring-credentials[configured in
Jenkins] can be handled in Pipelines for immediate use. Read more about using
credentials in Jenkins on the xref:user-docs:using-jenkins:using-credentials.adoc[Using
credentials] page.
