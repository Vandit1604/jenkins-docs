...
This section builds on the information introduced in xref:user-docs:pipeline:getting-started.adoc[Getting started with Pipeline] and should be treated solely as a reference.
...
As discussed at the xref:user-docs:pipeline:syntax.adoc[start of this chapter], the most fundamental part of a Pipeline is the "step". Basically, steps tell Jenkins _what_ to do and serve as the basic building block for both Declarative and Scripted Pipeline syntax.
...
As discussed at the xref:user-docs:pipeline:syntax.adoc[start of this chapter], the most fundamental part of a Pipeline is the "step".
