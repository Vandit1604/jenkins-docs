...
a|The versions of Winstone and Jetty bundled in the Jenkins xref:installing-jenkins:index.adocwar-file/[WAR file].
...
* xref:installing-jenkins:index.adocservlet-containers/[Installation instructions]
