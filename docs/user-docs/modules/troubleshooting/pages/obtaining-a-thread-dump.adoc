...
written to.
If you are running as a Windows service, see the xref:user-docs:installing-jenkins:windows.adoc[Windows installation instructions] for the log file location.
