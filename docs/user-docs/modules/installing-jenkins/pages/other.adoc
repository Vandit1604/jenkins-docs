...
Generally it should suffice to install a xref:user-docs:platform-information:support-policy-java.adoc[supported Java version], link:/download[download] the
