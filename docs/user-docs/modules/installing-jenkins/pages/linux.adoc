...
Jenkins requires Java in order to run, yet certain distributions don't include this by default and  xref:user-docs:administration:requirements/java.adoc[some Java versions are incompatible] with Jenkins.
