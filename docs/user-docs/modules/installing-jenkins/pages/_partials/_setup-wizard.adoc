...
[.boxshadow]
image::setup-jenkins-01-unlock-jenkins-page.jpg[alt="Unlock Jenkins page",width=80%]
...
[.boxshadow]
image::setup-jenkins-02-copying-initial-admin-password.png[alt="Copying initial admin password",width=80%] +
  *Note:* 
...
You can install (or remove) additional Jenkins plugins at a later point in time via the xref:managing:index.adoc[**Manage Jenkins**] > xref:managing:plugins.adoc[**Plugins**] page in Jenkins.
