...
IMPORTANT: It is strongly recommended to set up the xref:security:user-content.adoc#resource-root-url[Resource Root URL] instead of customizing Content-Security-Policy.
