...
If you need assistance or have general questions, visit us xref:chat:index.adoc[in chat], email one of the xref:mailing-lists:index.adoc[mailing lists], or post on the https://community.jenkins.io/[community forum].
...
plugin page.
** After selecting the link, if you end up on JIRA follow the instructions on <<Reporting an Issue in JIRA>>.
** After selecting the link, if you end up on Github follow the instructions on <<Reporting an Issue on Github>>.
...
+
[.boxshadow]
image:image:ROOT:participate/github-issues.png[alt="Github Issue Page",width=80%]

* Select *Get started* next to the type of issue you'd like to open.
+
[.boxshadow]
image:image:ROOT:participate/get-started.png[alt="Get Started Button",width=40%,align="center"]
...
xref:user-docs:administration:web-browsers.adoc[supported
web browsers].
