...
* **Release Permissions** which are needed to deploy releases to the xref:dev-docs:publishing:artifact-repository.adoc[Jenkins artifact repository].
...
Release Permissions are needed to deploy releases to the xref:dev-docs:publishing:artifact-repository.adoc[Jenkins artifact repository].
