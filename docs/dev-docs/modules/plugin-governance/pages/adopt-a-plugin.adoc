...
xref:dev-docs:plugin-development:mark-a-plugin-incompatible.adoc[you can mark a new version as being incompatible with older releases] to warn users before they update.
