...
See the xref:dev-docs:plugin-development:choosing-jenkins-baseline.adoc[developer documentation] for the recommended minimum Jenkins version.
...
The `version` may also need an upgrade see the xref:dev-docs:plugin-development:dependency-management.adoc#jenkins-plugin-bom[developer documentation].
