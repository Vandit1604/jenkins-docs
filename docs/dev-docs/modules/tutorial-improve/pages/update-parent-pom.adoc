...
* Prevent cross-site scripting by xref:xss-prevention.adoc[escaping expressions in Jelly pages]
* Resolve ambiguous property encodings by xref:tutorial-improve:convert-translations.adoc[converting translations with native2ascii]
