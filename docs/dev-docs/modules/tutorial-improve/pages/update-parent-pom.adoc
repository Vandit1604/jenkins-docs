...
* Resolve xref:dev-docs:plugin-development:updating-parent.adoc#understanding-requireupperbounddeps-failures-and-fixes[upper bounds dependency warnings]
* Prevent cross-site scripting by xref:dev-docs:security:xss-prevention.adoc[escaping expressions in Jelly pages]
