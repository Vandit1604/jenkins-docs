...
* xref:dev-docs:security:csrf-protection.adoc[CSRF Protection]
...
If you are not familiar with Jenkins architecture, you can have a look to xref:dev-docs:architecture:model.adoc[High level view of Jenkins application] and at xref:dev-docs:architecture:index.adoc[Architecture]
