...
If you are not familiar with Jenkins architecture, you can have a look to xref:architecture:model.adoc[High level view of Jenkins application] and at xref:architecture:model.adoc[Architecture]
