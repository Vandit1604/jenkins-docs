...
For an overview of the URLs accessible to users without any permissions in Jenkins, see xref:access-control.adoc[Access Control].
...
Instead, it provides a shell-like interface for the xref:user-docs:managing:cli.adoc[Jenkins CLI].
