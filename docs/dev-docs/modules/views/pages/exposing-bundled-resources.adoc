...
For the classic Jenkins UI, they are generally used directly as described in xref:dev-docs:internationalization:index.adoc[Internationalization and Localization].
