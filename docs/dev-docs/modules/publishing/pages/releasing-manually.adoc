...
====
See xref:publishing:releasing-cd.adoc[setting up automated plugin release] instead of this guide.
====

== Prerequisites

. Make sure you have permissions to release the plugin. xref:publishing:requesting-hosting.adoc[See this guide to learn more details]

== Artifactory Credentials for Maven

You will need to tell Maven your credentials to access xref:publishing:artifact-repository.adoc[Artifactory].
