...
. Review the - xref:publishing:preparation[preparation steps] and make sure they're satisfied.
. Make sure your plugin follows the plugin naming convention outlined in the - xref:publishing:style-guides.adoc[style guides].
...
See - xref:publishing:continuous-integration.adoc[the documentation for CI builds] for details how to do this.
...
Once you've completed this step and your request has been merged, you will be able to - xref:publishing:releasing.adoc[release your plugin].
...
image::hosting/jira-auto-reference.png[]
