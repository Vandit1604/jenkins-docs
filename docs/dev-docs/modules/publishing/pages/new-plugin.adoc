...
Just run the following command on the command line (with Maven and JDK installed, see xref:plugin-tutorial:index.adoc[the tutorial]), and follow the interactive instructions:
