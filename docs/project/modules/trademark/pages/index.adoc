...
A list of trademark usages approved by the project can be found on the xref:project:trademark:approved-usage.adoc[Approved Trademark Usage] page.
...
* xref:project:trademark:approved-usage.adoc[Approved Trademark Usage (before Feb 24, 2021)]
****
...
* We are not applying requirements retrospectively, all xref:project:trademark:approved-usage.adoc[previously approved trademark usages] remains approved.
