...
This document lists the use of the "Jenkins" mark approved by the xref:project:governance-meeting:index.adoc[project meeting], along with its meeting notes.
