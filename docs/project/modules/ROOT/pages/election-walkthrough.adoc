...
If you are interested in the election process, please read the xref:board-election-process.adoc[Board and Officer election process] and the xref:governance.adoc[governance] documents.
...
image::new-message.png[Propose a new message]
...
image::send-message.png[Send new message]
...
image::join-election-group.png[Joining the annual election group]
...
image::activate-civs-account.png[Activate your CIVS account]
...
image::confirm-civs-account.png[Confirm your CIVS account]
...
image::proceed-to-vote.png[Proceed to vote with your CIVS account]
...
image::voting-successful.png[The voting was successful]
