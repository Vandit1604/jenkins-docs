...
This document outlines the xref:ROOT:governance.adoc#governance-board[Jenkins Governance Board] and link:/project/team-leads/[Jenkins officer] election process.
...
You can find out more about our philosophy in the xref:ROOT:governance.adoc[Governance Document].
...
* Introduce a new xref:ROOT:team-leads.adoc#documentation[Documentation officer position] (content officer from the 2015 Proposal).
