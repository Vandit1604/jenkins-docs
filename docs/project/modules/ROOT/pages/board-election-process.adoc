...
* If a board member gets employed by a company and the limitation gets violated, somebody must step down and the board will follow the xinterim-procedures[#Interim Procedures]
