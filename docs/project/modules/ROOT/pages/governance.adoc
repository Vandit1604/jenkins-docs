...
The xref:board:index.adoc[Governance Board] page provides further information, including a list of current board members, and how to contact the board.
...
Infrastructure components are maintained by the xrefs:infrastructure:index.adoc[infrastructure project].
See the xrefs:infrastructure:index.adoc#contributing[contributing guidelines] for more information.
...
Twitter::
link:https://twitter.com/jenkinsci[@jenkinsci] is the official Twitter account of the Jenkins project, run by the team of contributors ({jep}10/README.adoc[]).
...
See the xrefs:infrastructure:index.adoc[Jenkins Infrastructure] page for the full list of services and more details.
...
* {jep}14/README.adoc[Public Jenkins Roadmap Process]

[[meeting]]
== Decision making

The Jenkins project uses xref:governance-meeting:index.adoc[biweekly project meetings] as the primary forum of decision making for matters that need consensus.
...
Agenda items can be added by anyone by simply adding your topic to xref:governance-meeting:index.adoc[the Governance Meeting Agenda].

The meeting minutes are public:

* xref:governance-meeting:index.adoc[Governance Meeting Agenda] for meetings held in as video calls
