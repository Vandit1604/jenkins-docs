...
For more details about our cultural values, goals, philosophies, and structure, please consult our xref:ROOT:governance.adoc[Governance Document]. 
...
* xrefs:jam:index.adoc[Jenkins Area Meetups]
...
reported by contacting the xref:board:index.adoc[Jenkins board].
...
This email list is only readable by the xref:board:index.adoc[Governance Board] members.
...
xref:board:index.adoc[Governance
Board] page).
