...
As per the Jenkins xref:project:governance-meeting:index.adoc[Governance Document], the community holds a regular governance meeting.
...
If a decision cannot be made at the governance meeting, the project's xref:project:board:index.adoc[governance board] takes priority.
