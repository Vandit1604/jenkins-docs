...
Our
xref:project:governance-meeting:index.adoc[Governance
...
For more info about trademark and its usage see the xref:project:governance-meeting:index.adoc#trademark[Trademark] and xref:project:governance-meeting:index.adoc#trademark-attribution[Trademark Attribution] sections of the Governance document.
...
image::images:ROOT:logo_128.png[title="Jenkins", float=right]
