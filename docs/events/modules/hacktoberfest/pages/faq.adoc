...
If you're hosting a Hacktoberfest online meetup related to Jenkins, share it with the rest of the world as a xref:online-meetup:index.adoc[Jenkins Online Meetup].
