...
image:images:images/hacktoberfest/hacktoberfest_2022.png[Hacktoberfest, role=center]
...
| Design
| Create new images and logos for xref:projects:ROOT:index.adoc/jam/[Jenkins area meetups],
...
| xref:projects:ROOT:index.adoc/infrastructure/#pick-up-a-task[Jenkins Infrastructure]
...
* You might want to read the Jenkins Infrastructure's xref:projects:ROOT:index.adoc/infrastructure/#contributing[Contributing Guide]
...
See the xref:plugin-tutorial:index.adoc[Plugin Tutorial] and
xref:publishing:requesting-hosting.adoc[Hosting Plugins] guidelines for more information.
