...
* Test xref:user-docs:installing-jenkins:index.adoc[installation guidelines] and xref:tutorials:index.adoc[tutorials],
...
* **Advanced:** Create new xref:tutorials:index.adoc[Tutorials], e.g. how to use a Jenkins feature or how to implement a common automation use-case with Jenkins
