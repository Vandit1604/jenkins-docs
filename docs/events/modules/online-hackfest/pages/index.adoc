...
In particular, we thank link:/sigs/ux/[User Experience], xref:sigs:docs:index.adoc[Documentation] and xref:sigs:advocacy-and-outreach:index.adoc[Advocacy and Outreach] SIG members who heavily contributed to this event.
