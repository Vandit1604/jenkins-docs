...
Note: Project ideas should not be confused with xref:projects:gsoc:students.adoc#student-proposals[GSoC applicant proposals].

GSoC applicants: to browse the existing project ideas offered by the Jenkins Organisation,
please read the instructions on the xref:projects:gsoc:students.adoc[GSoC contributor page].
