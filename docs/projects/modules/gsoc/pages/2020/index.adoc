...
use public contacts listed xref:projects:gsoc:index.adoccontacts[here].

== Other materials

* xref:projects:gsoc:2020/project-ideas[GSoC 2020 project ideas]
* xref:projects:gsoc:2020/application.adoc[GSoC 2020 application and organization profile]
