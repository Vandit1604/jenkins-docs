...
* xref:ROOT:index.adoc/gsoc/2018/code-coverage-api-plugin[Code Coverage API Plugin]
* xref:ROOT:index.adoc/gsoc/2018/remoting-over-message-bus[Jenkins Remoting over Message Bus/Queue]
* xref:ROOT:index.adoc/gsoc/2018/simple-pull-request-job-plugin[Simple Pull-Request Job Plugin]

Not started:

* xref:ROOT:index.adoc/gsoc/2018/eda-plugins[Electronic Design Automation Plugins]
...
* xref:ROOT:index.adoc/gsoc/gsoc2018-project-ideas[GSoC 2018 Project ideas]
