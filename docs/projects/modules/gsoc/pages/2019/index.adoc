...
* xref:projects:ROOT:index.adoc/gsoc/2019/schedule.adoc[GSoC 2019 schedule]
* xref:sigs:gsoc:index.adoc[Jenkins GSoC Special Interest Group]
* xref:projects:gsoc:2019/project-ideas.adoc[GSoC 2019 project ideas]
* xref:projects:gsoc:2019/application.md[GSoC 2019 application draft]
