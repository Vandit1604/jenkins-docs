...
// image:/images/gsoc/jenkins-gsoc-logo_small.png[Jenkins GSoC, role=center, float=left,role=float-gap]
...
* xref:projects:ROOT:index.adoc/gsoc/2023/projects/gitlab-plugin-modernization[GitLab Plugin Modernization] with link:https://github.com/harsh-ps-2003[Harsh Pratap Singh] as GSoC contributor.
* xref:projects:ROOT:index.adoc/gsoc/2023/projects/add-probes-to-plugin-health-score[Add probes to "Plugin Health Score"] with link:https://github.com/Jagrutiti[Jagruti Tiwari] as GSoC contributor.
* xref:projects:ROOT:index.adoc/gsoc/2023/projects/alternative-jenkinsio-build-tool[Building Jenkins.io with alternative tools] with link:/blog/authors/vandit1604/[Vandit Singh] as GSoC contributor.
* xref:projects:ROOT:index.adoc/gsoc/2023/projects/docker-compose-build[Docker-based Jenkins quickstart examples] with link:/blog/authors/ash-sxn/[Ashutosh Saxena] as GSoC contributor.
...
* xref:projects:ROOT:index.adoc/gsoc/students[Information and application guidelines for GSoC contributors]
...
* xref:projects:ROOT:index.adoc/gsoc/mentors[Information for mentors]
* xref:projects:ROOT:index.adoc/gsoc/proposing-project-ideas[HOWTO: Propose a project idea]
* xref:projects:ROOT:index.adoc/gsoc/roles-and-responsibilities[Roles and Responsibilities]
* link:https://summerofcode.withgoogle.com/[Google Summer of Code portal]
...
* xref:projects:ROOT:index.adoc/gsoc/2022[GSoC 2022] - 4 student projects
* xref:projects:ROOT:index.adoc/gsoc/2021[GSoC 2021] - 5 student projects
* xref:projects:ROOT:index.adoc/gsoc/2020[GSoC 2020] - 7 student projects
* xref:projects:ROOT:index.adoc/gsoc/2019[GSoC 2019] - 7 student projects
* xref:projects:ROOT:index.adoc/gsoc/2018[GSoC 2018] - 3 student projects
* xref:projects:ROOT:index.adoc/gsoc/gsoc2017[GSoC 2017] - not accepted
* xref:projects:ROOT:index.adoc/gsoc/gsoc2016[GSoC 2016] - 5 student projects
