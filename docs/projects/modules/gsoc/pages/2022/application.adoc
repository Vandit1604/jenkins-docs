...
Jenkins project includes multiple sub-projects (including xref:projects:jcasc:index.adoc[Configuration-as-Code], xref:projects:infrastructure:index.adoc[Infrastructure] and xref:projects:remoting:index.adoc[Remoting]) and link:/sigs/[special interest groups].
