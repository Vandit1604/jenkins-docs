...
GSoC Contributor resources can be found xref:projects:gsoc:students.adoc[here].
...
* xref:projects:gsoc:index.adoc#orgadmin[Mailing list for contacting Org Admins]
