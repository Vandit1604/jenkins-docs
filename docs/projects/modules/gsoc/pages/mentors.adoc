...
** make sure the GSoC Contributors determine whether they are xref:gsoc:students.adoc#eligibility-steps[eligible]
...
We have written a guide for this phase, xref:gsoc:students.adoc#community-bonding[read it] and follow it.
...
See also: xref:gsoc:students.adoc#coding-periods[student coding periods].
...
See also: xref:gsoc:students.adoc#evaluations[student evaluations].
