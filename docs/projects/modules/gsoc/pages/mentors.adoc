...
GSoC Contributor resources can be found xref:ROOT:index.adoc/gsoc/students[here].
...
* xref:ROOT:index.adoc/gsoc/#orgadmin[Mailing list for contacting Org Admins]
...
You can also xref:ROOT:index.adoc/gsoc/proposing-project-ideas[propose your own project] for GSoC, see below.
...
** make sure the GSoC Contributors determine whether they are xref:projects:gsoc:students.adoc#eligibility-steps[eligible]
...
We have written a guide for this phase, xref:projects:gsoc:students.adoc#community-bonding[read it] and follow it.
...
See also: xref:projects:gsoc:students.adoc#coding-periods[student coding periods].
...
See also: xref:projects:gsoc:students.adoc#evaluations[student evaluations].
