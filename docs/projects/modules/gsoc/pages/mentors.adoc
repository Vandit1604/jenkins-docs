...
GSoC Contributor resources can be found xref:projects:ROOT:index.adoc/gsoc/students[here].
...
* xref:projects:ROOT:index.adoc/gsoc/#orgadmin[Mailing list for contacting Org Admins]
...
You can also xref:projects:ROOT:index.adoc/gsoc/proposing-project-ideas[propose your own project] for GSoC, see below.
