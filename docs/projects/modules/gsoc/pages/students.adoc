...
See xref:gsoc:index.adoc[the main GSoC project] page for other information and links.
...
. Check out the xref:ROOT:index.adoc/gsoc/2023/project-ideas[GSoC 2023 Project ideas]
...
. Add GSoC office hours to your calendar (to be announced on xref:gsoc:index.adoc[the main GSoC project] page).
...
* xref:ROOT:index.adoc/gsoc/#orgadmin[Org admins mailing list]- for **private** communications with org admins (escalations, issues with mentors)
...
See the xref:ROOT:index.adoc/gsoc/#office-hours[main GSoC page] for the schedule.
...
. Present your work at a local xref:jam:index.adoc[Jenkins Area Meetup]
