...
In 2019 there was a Jenkins xref:ROOT:index.adoc/gsoc/2019/plugin-installation-manager-tool-cli/[Google Summer of Code project] to create a tool to link:https://github.com/jenkinsci/plugin-installation-manager-tool/#readme[automatically install plugins] from the command line based on a provided input.
