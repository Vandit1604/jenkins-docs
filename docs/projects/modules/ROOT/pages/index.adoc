...
image:images:ROOT:gsod/gsod.png["Google Season of Docs", role=left]
...
image:images:ROOT:gsoc/jenkins-gsoc-logo_small.png["Summer of Code", role=right, width=128]
...
image:images:ROOT:network-workgroup.png["Infrastructure', role=left]
...
image:images:ROOT:user.svg["Social Jenkins events", role=right]
...
image:images:ROOT:logos/JCasC/JCasC.svg["Jenkins Configuration as Code", role=right, height=180]
...
image:images:ROOT:logos/kubernetes-operator/256.png["Jenkins Operator", role=left]
