...
:page-author: olblak
:page-opengraph: ../../images/post-images/2021-03-01-update-center-certificate-rotation/certificate-rotation-opengraph.png
description: Announcement, updates.jenkins.io certificate rotation
---

image:/post-images/2021-03-01-update-center-certificate-rotation/certificate-rotation-opengraph.png[Jenkins update center certificate rotation, role=center, float=right, height=270]
