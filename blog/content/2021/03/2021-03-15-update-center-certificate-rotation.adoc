...
:page-opengraph:
  image: /images/post-images/2021-03-01-update-center-certificate-rotation/certificate-rotation-:page-opengraph.png
---

image:/images/post-images/2021-03-01-update-center-certificate-rotation/certificate-rotation-:page-opengraph.png[Jenkins update center certificate rotation, role=center, float=right, height=270]
