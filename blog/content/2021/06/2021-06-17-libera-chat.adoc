...
:page-opengraph:
  image: /images/post-images/2021-06-libera-chat/jenkins-irc-on-libera-chat-:page-opengraph.png
---

image:/images/post-images/2021-06-libera-chat/jenkins-irc-on-libera-chat-:page-opengraph.png[Jenkins IRC now on Libera Chat, role=center, link="/chat/#internet-relay-chat-irc"]
