...
:page-author: aki-7
:page-opengraph: ../../images/post-images/2021-07-31-remoting-monitoring-phase-1/remoting-monitoring-phase-1-opengraph.png
description:   Remoting Monitoring: Summary of coding phase 1 of Google Summer of Code
---

image:/post-images/2021-07-31-remoting-monitoring-phase-1/opengraph.png[Remoting Monitoring with OpenTelemetry]
