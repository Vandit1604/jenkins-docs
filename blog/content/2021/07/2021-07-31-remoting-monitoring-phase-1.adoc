...
:page-opengraph:
  image: /images/post-images/2021-07-31-remoting-monitoring-phase-1/remoting-monitoring-phase-1-:page-opengraph.png
---

image:/images/post-images/2021-07-31-remoting-monitoring-phase-1/:page-opengraph.png[Remoting Monitoring with OpenTelemetry]
