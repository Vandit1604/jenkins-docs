...
:page-opengraph: /post-images/2023/03/29/2023-03-22-android-and-jenkins/love.png
discourse: true
---
...
image:/post-images/2023/05/02/2023-05-02-android-and-jenkins-releases/too-many-releases.png[Too many releases, role=center, width=839]
