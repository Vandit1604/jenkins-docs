...
image:/post-images/2020/05-read-only-jenkins-announcement/build-discarder-edit.png[]

Non editable:

image:/post-images/2020/05-read-only-jenkins-announcement/build-discarder-read.png[]
