...
:page-opengraph: ../../images/post-images/2020/07-external-fingerprint-storage-phase-2/:page-opengraph.png
---
...
image:/post-images/2020/07-external-fingerprint-storage-phase-2/cleanup_disable.png[Fingerprint cleanup disable]
...
image:/post-images/2020/07-external-fingerprint-storage-phase-2/fingerprint_storage_engine_dropdown.png[Fingerprint
