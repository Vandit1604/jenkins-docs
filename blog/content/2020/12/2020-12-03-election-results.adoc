...
:page-opengraph: ../../images/images/governance/elections/2020/:page-opengraph.png
description: >
  This blogpost summarizes
---

image:/images/governance/elections/2020/:page-opengraph.png[Jenkins Elections, role=center, float=right, height=178]
