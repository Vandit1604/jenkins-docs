...
image:/post-images/remoting-kafka-intro/remoting-kafka-architecture.png[title="Remoting Kafka Plugin Current Architecture", role="center"]
...
image:/post-images/remoting-kafka-intro/kafka-global-config.png[title="Remoting Kafka Global Configuration", role="center"]

=== 2. Custom agent start up as a JAR
User can start running an agent with the following command:
image:/post-images/remoting-kafka-intro/start-agent.png[title="Command to start an agent", role="center"]

=== 3. Launch agents with Kafka
image:/post-images/remoting-kafka-intro/launch-agent-kafka.png[title="Launch agent with Kafka", role="center"]

=== 4. Commands transferred between controller and agent over Kafka
image:/post-images/remoting-kafka-intro/kafka-commands.png[title="controller-agent communication with Kafka", role="center"]
...
image:/post-images/remoting-kafka-intro/remoting-kafka-run-job.png[title="Job run with Remoting Kafka Plugin", role="center"]
