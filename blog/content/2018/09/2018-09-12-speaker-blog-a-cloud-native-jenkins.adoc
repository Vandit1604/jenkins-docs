...
image::/post-images/2018-09-12-cloud-native-jenkins/single-shot-master-schema.png[Single-shot controller concept, link="https://www.cloudbees.com/devops-world"]
