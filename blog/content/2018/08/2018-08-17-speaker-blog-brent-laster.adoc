...
image::/post-images/2018-08-17/figure1.png[The Snippet Generator, 800]
...
image::/post-images/2018-08-17/figure2.png[Link to Global Variables Reference section]
...
image::/post-images/2018-08-17/figure3.png[Docker global variable specifics, 800]
...
image::/post-images/2018-08-17/figure4.png[Key methods for getting a Docker image]
...
image::/post-images/2018-08-17/figure5.png[Actual Docker output from running the download and build]
...
image::/post-images/2018-08-17/figure6.png[Example inside method Docker command output, 800]
