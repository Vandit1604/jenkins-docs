...
image:/post-images/update-plugin-for-pipeline-tutorial/05_snippet_generator_archive.png[archive
snippet, role=center]
...
image:/post-images/update-plugin-for-pipeline-tutorial/10_snippet_generator.png[gatlingArchive
snippet, role=center]
...
image:/post-images/update-plugin-for-pipeline-tutorial/15_archive_metastep_snippet.png[archive
...
image:/post-images/update-plugin-for-pipeline-tutorial/20_gatling_metastep_snippet.png[gatling
...
image:/post-images/update-plugin-for-pipeline-tutorial/25_gatling_project_page.png[gatling
