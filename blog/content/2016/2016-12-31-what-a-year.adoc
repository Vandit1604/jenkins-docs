...
image:/post-images/blueocean/pipeline-run.png[Blue Ocean, role=center]
...
image:/post-images/2016-jenkins-world-wrap/demo-crowd.jpg[Demo Crowd, width=480, role=right]
...
image:/post-images/2016-in-review/jam-worldwide-2016.png["Jenkins Around the World Meetups", role=center]
