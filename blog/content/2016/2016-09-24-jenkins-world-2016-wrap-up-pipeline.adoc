...
image:/post-images/scaling-jenkins-at-jenkinsworld/320px-CloudBees_official_logo.png[role=left]
...
image:/post-images/pipeline-at-jenkinsworld/nextsource_logo.jpg[Nextsource, role=right]
...
image:/post-images/2016-jenkins-world-wrap/android-pipeline.png[Continuous Build and Delivery Pipelines for Android,width=240,role=left]
...
image:/post-images/2016-jenkins-world-wrap/declarative-pipeline.png[A New Way to Define Jenkins Pipelines,width=240,role=right]
...
image:/post-images/pipeline-at-jenkinsworld/perforce.png[Perforce, role=left]
...
image:/post-images/2016-jenkins-world-wrap/faster-pipelines-code.png[Building Pipelines To Be Faster,width=240,role=right]
...
image:/post-images/2016-jenkins-world-wrap/google-summer-of-code.png[Google Summer of Code,width=240,role=right]
...
image:/post-images/pipeline-at-jenkinsworld/redhat.png[Red Hat,role=left]
