...
____
image:/post-images/pipeline-at-jenkinsworld/nextsource_logo.jpg[role=right]
...
image:/post-images/pipeline-at-jenkinsworld/perforce.png[role=right]
...
____
image:/post-images/scaling-jenkins-at-jenkinsworld/320px-CloudBees_official_logo.png[role=right]
...
[quote, Mark Galpin]
____
image:/post-images/pipeline-at-jenkinsworld/jfrog.png[role=right]
...
____
image:/post-images/pipeline-at-jenkinsworld/redhat.png[role=right]
...
____
image:/post-images/pipeline-at-jenkinsworld/aquilent.png[role=left]
