...
image::/post-images/2016-06-16/serial.png[Serial Test Pipeline, role=center]
...
image::/post-images/2016-06-16/serial-vs-parallel.png[Pipeline Duration Comparison, role=center]
