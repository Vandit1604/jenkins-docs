...
image::/post-images/freestyle-to-pipeline-2016/freestyle-pipeline.png[role=center]
...
image::/post-images/freestyle-to-pipeline-2016/stats-pipeline.png[The New and Improved Statistics Pipeline, role=center]
