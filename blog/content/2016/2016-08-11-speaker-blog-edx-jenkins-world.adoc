...
Picking a pear from a basket is straightforward when you can hold it in your hand, feel its weight, perhaps give a gentle squeeze, observe its color and look more closely at any bruises. If the only information we had was a photograph from one angle, we’d have to do some educated guessing. image:/post-images/1pear.png[role=right]
...
image:/post-images/5pears.png[role=center]
...
image:/post-images/jenkins-run-python.png[role=center]
...
image:/post-images/95th-percentile.png[role=center]
