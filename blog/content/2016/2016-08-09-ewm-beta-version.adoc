...
image:/post-images/ewm/global-custom-workspace-path.png[title="Global Custom Workspace Path", role="center"]
...
image:/post-images/ewm/restriction-by-user.png[title="Disk Pool Restriction By User", role="center"]

Or, we can restrict the Disk Pool to be allocated only for those jobs whose name matches a well defined pattern:

image:/post-images/ewm/restriction-by-job-name.png[title="Disk Pool Restriction By Job Name", role="center"]
...
image:/post-images/ewm/global-disk-allocation-strategy.png[title="Global Disk Allocation Strategy", role="center"]
