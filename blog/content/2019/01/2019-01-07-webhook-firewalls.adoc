...
image:/post-images/2019-01-07-webhook-firewalls/webhooks.png[webhook diagram, role=center]
...
image:/post-images/2019-01-07-webhook-firewalls/firewalls.png[firewall diagram, role=center]
...
image:/post-images/2019-01-07-webhook-firewalls/exposed.png[exposed on web, role=center]
...
image:/post-images/2019-01-07-webhook-firewalls/forwarding.png[forwarding, role=center]
...
image:/post-images/2019-01-07-webhook-firewalls/smee.png[smee website, role=center]

This will give you a unique URL (which you should copy for later use): 

image:/post-images/2019-01-07-webhook-firewalls/config1.png[smee config, role=center]
...
image:/post-images/2019-01-07-webhook-firewalls/newpipeline.png[new pipeline, role=center]

I then chose “GitHub” as the where the code is: 

image:/post-images/2019-01-07-webhook-firewalls/choice.png[choose github, role=center]
...
image:/post-images/2019-01-07-webhook-firewalls/addwebhook.png[add webhook, role=center]
...
image:/post-images/2019-01-07-webhook-firewalls/config2.png[config webhook, role=center]

OK - webhooks should be flowing now. You can make a change to your repository, and check that a build starts soon after:

image:/post-images/2019-01-07-webhook-firewalls/running.png[running pipeline, role=center]
