...
image::/post-images/2019-01-08-mpl/fig01-layers-of-the-mpl.png["Fig 1. Layers of the MPL", 800, role=center]
...
image::/post-images/2019-01-08-mpl/fig02-the-mpl-process.png["Fig 2. The MPL process", 800, role=center]
...
image::/post-images/2019-01-08-mpl/fig03-a-simplified-mpl-repository-structure.png["Fig 3. A simplified MPL repository structure", 800, role=center]
...
image::/post-images/2019-01-08-mpl/fig04-ways-to-use-the-mpl.png["Fig 4. Ways to use the MPL", 800, role=center]
...
image::/post-images/2019-01-08-mpl/fig05-example-of-a-companys-libraries-tree-structure.png["Fig 5. Example of company's libraries tree structure", 800, role=center]
...
image::/post-images/2019-01-08-mpl/fig06-mpl-modules-overriding.png["Fig 6. MPL modules overriding", 800, role=center]
...
image::/post-images/2019-01-08-mpl/fig07-petclinic-selenium-example-pipeline-structure.png["Fig 7. Petclinic-Selenium example pipeline structure", 800, role=center]
