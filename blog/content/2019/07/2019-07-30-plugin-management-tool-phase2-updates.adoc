...
image::/post-images/gsoc-plugin-management-tool/yamlexample.png[Yaml Input Example]

image::/post-images/gsoc-plugin-management-tool/yamlcli.png[Yaml CLI Example]
...
image::/post-images/gsoc-plugin-management-tool/listplugins.png[List CLI Option Example]
...
image::/post-images/gsoc-plugin-management-tool/securitywarnings.png[Security Warning CLI Option Example]

image::/post-images/gsoc-plugin-management-tool/available-updates.png[Security Warning CLI Option Example]
