...
:page-opengraph: ../../images/post-images/2019-11-plugin-creds-secure-store/PluginWebForm.png
...
image::/post-images/2019-11-plugin-creds-secure-store/PluginWebForm.png[]
