...
image::/post-images/2019-02-06-ssh-steps/JenkinsPlusSSH.png[SSH Steps, role=center]
...
image::/post-images/2019-02-06-ssh-steps/jenkins-ssh-deploy.png[SSH Deploy BlueOcean View, width=80%, role=center]
