...
:page-opengraph: ../../images/post-images/role-strategy-performance/benchmarks2.png
...
image::/post-images/role-strategy-performance/benchmarks1.png[Benchmarks results after caching matching roles]
...
image::/post-images/role-strategy-performance/benchmarks2.png[Benchmarks results after both changes]
...
image::/post-images/role-strategy-performance/jcasc-export.png[Role Strategy configuration export working with JCasC 1.24]
