...
image:/post-images/remoting-kafka/kafka-provisioning-kubernetes-ui.png[Apache Kafka provisioning in Kubernetes UI]
...
image:/post-images/remoting-kafka/cloud-ui.png[Remoting Kafka Cloud UI]
...
image:/post-images/remoting-kafka/cloud-nodes.png[Remoting Kafka Agent get provisioned]
