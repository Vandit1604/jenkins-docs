...
image:/post-images/blueocean-dev-log/editor-mar-1.png["Editing a Pipeline", role=center]
...
image:/post-images/blueocean-dev-log/favorites-mar-1.png["Pipeline Favorites", role=center]
...
image:/post-images/blueocean-dev-log/editor-topbar-link.png["Editing a Pipeline", role=center]

Or open the editor from branch listings:

image:/post-images/blueocean-dev-log/editor-run-listing-link.png["Editing a Pipeline", role=center]
