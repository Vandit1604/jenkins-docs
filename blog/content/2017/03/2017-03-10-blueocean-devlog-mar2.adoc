...
image::/post-images/blueocean-dev-log/edit-action-items.png["Editing a Pipeline", role=right]
...
image::/post-images/blueocean-dev-log/editor-save-dialog.png["Editing and saving a Pipeline", role=center]
