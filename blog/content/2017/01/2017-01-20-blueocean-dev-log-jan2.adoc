...
image:/post-images/blueocean-dev-log/start-with-parameters.png["Starting with parameters from @thorscherler", role=center]
...
image:/post-images/blueocean-dev-log/gui-editor.png["Pipeline Editor plugin", role=center]
