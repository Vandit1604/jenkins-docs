...
image:/post-images/blueocean-dev-log/pipeline-creation-flow.png["Creating a Pipeline in Blue Ocean", role=center]
...
image:/post-images/blueocean-dev-log/connection-lost.png["Lost connection", role=center]
...
image:/post-images/blueocean-dev-log/connection-ok.png["Reconnected", role=center]
