...
image:/post-images/sonarqube-jenkins/01_PipelineFailedBlueOcean.png[role=center]
...
image:/post-images/sonarqube-jenkins/02_Finding.png[role=center]
...
image:/post-images/sonarqube-jenkins/03_FindingVisualizedInCode.png[role=center]
...
image:/post-images/sonarqube-jenkins/04_PipelineFixedBlueOcean.png[role=center]
...
image:/post-images/sonarqube-jenkins/05_BinaryDeployedInArtifactory.png[role=center]
