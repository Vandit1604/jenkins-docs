...
image:/post-images/blueocean-dev-log/creating-pipeline-from-github.png["Creating a Pipeline from GitHub", role=center]
...
image::/post-images/blueocean-dev-log/branch-filtering.png["Filtering a branch", role=center]
