...
image::/post-images/2017-02-07/junit-config.png[JUnit Multi-branch Pipeline Configuration, role="center"]
...
image::/post-images/2017-02-07/junit-minimal.png[Minimal Declarative Pipeline, role="center"]
...
image::/post-images/2017-02-07/junit-tools.png[Declarative Pipeline with Tools Section, role="center"]
