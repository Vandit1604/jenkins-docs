...
image:/post-images/blueocean-dev-log/new-design-overview.png["Overview", role=center]
...
image:/post-images/blueocean-dev-log/new-design-success.png["Successful Pipeline", role=center]

image:/post-images/blueocean-dev-log/new-design-failure.png["Failing Pioeline", role=center]
