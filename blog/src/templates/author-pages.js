            ...
            <>
              ...
              <div className={authoravataricons} style={{ width: "10rem" }}>
                {node.node.pageAttributes.github ? (
                  <a href={"https://github.com/" + node.node.pageAttributes.github}>
                ...
                {node.node.pageAttributes.linkedin ? (
                  <a href={"https://linkedin.com/in/" + node.node.pageAttributes.linkedin}>
                ...
                {node.node.pageAttributes.twitter ? (
                  <a href={"https://twitter.com/" + node.node.pageAttributes.twitter}>
      ...
      <ul className={bloglisting}>
        {data.allFile.nodes.map(({ childrenAsciidoc }) => {
          ...
          const opengraphImageSource =
            childrenAsciidoc[0].pageAttributes.opengraph || "../../images/gsoc/opengraph.png";
          return (
            <li
            ...
            >
              ...
              >
                ...
                <div className={blogteaser}>
                  Will include the blog teaser Lorem ipsum dolor sit amet, officia excepteur ex
                  fugiat reprehenderit enim labore culpa sint ad nisi Lorem pariatur mollit ex esse
                  ...
                  ex occaecat reprehenderit commodo officia dolor Lorem duis laboris cupidatat
