  ...
  <section style={{ padding: "3rem 12rem", display: "flex" }}>
    ...
    <Box display={"flex"} flexDirection={"column"}>
      ...
      <p>
        ...
        <br />
        <br />
        We stand with the people of Ukraine. Please assist humanitarian efforts for the Ukrainian
        people and those affected by the military invasion of Ukraine by supporting international
        aid organizations, including the{" "}
        <a href="https://redcross.org.ua/en/donate/">Ukrainian Red Cross</a>
      </p>
      <div
        style={{ display: "flex", width: "fit-content", justifyContent: "flex-start", gap: "1rem" }}
      >
        <Link to="/download">
          <Button variant="contained" sx={{ backgroundColor: "#616161", borderRadius: "0.5rem" }}>
            Download
          </Button>
        </Link>
        <a href="https://vandit1604.github.io/jenkins-docs/user-docs/2.401.3/index.html">
          <Button variant="contained" sx={{ backgroundColor: "#D32F2F", borderRadius: "0.5rem" }}>
            Documentation
          </Button>
        </a>
      </div>
