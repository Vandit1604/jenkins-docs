    ...
    <div className={container}>
      <div className={box}>
        <div>
          ...
          <p>
            As an extensible automation server, Jenkins can be used as a simple CI server or turned
      ...
      <div className={box}>
        <div>
          ...
          <p>
            Jenkins can be easily set up and configured via its web interface, which includes
