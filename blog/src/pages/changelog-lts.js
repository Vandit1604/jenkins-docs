  ...
  render() {
    ...
    return (
      <IndexPageLayout>
        ...
        >
          See the <Link to="/upgrade-guide">LTS upgrade guide</Link> advice on
          upgrading Jenkins.
        </div>
            ...
            <ul>
              {node.changes?.map((change) => {
                return (
                  <li>
                    <span
                      dangerouslySetInnerHTML={{ __html: change.message }}
                    />
                    <span>
                      <a
                        href={
            ...
            <ul>
              {node.lts_changes?.map((references) => {
                return (
                  <li>
                    <span
                      dangerouslySetInnerHTML={{ __html: references.message }}
                    />
                    {(() => {
