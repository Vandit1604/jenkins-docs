...
const ChangelogLTS = ({ data }) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // Extract JavaScript object from the script text
    ...
    // Function to parse JavaScript object from script text
    const parseDataFromScript = (scriptText) => {
        // Extract the JavaScript object from the script text
        const jsonString = scriptText.match(/\{.*\}/s)[0];
        // Convert the JavaScript object string to JSON
