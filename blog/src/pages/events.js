...
const EventPage = ({ data }) => {
  ...
  return (
    <IndexPageLayout>
      ...
      <p>
        There are many online and local Jenkins-related events: including
        conferences, meetups, webinars, hackathons, etc.
      </p>
      <ul>
        <li>
          <a href="add link">Jenkins Online Meetup.</a> Our project has a
          virtual meetup for users and developers. We organize regular events
          and webinars there.
        </li>
        <li>
          <a href="add link">Local meetups.</a> Jenkins contributors organize
          many local CI/CD and Jenkins meetups around the world. There might be
          one in your city!
        </li>
        <li>
          <a href="add link">Contributor Summits.</a> We organize a few
          contributor summits every year. It brings together current community
          members and future contributors to learn, meet, and help shape the
          future of Jenkins.
        </li>
        <li>
          <a href="add link">DevOps World.</a> CloudBees organizes the DevOps
          World conference and includes Jenkins topics in the conference agenda.
        </li>
        <li>
          <a href="add link">Hacktoberfest.</a> Jenkins project is participating
          to Hacktoberfest.
        </li>
      </ul>
      <section>
      ...
      <section>
        ...
        <p>
          We have a calendar which lists events related to Jenkins, including
          regular SIG and project meetings. This calendar is also available in
          the ({" "}
