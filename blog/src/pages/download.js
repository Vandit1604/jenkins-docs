...
const DownloadPage = () => (
  <IndexPageLayout>
    ...
    <p>
      The Jenkins project produces two release lines: Stable (LTS) and regular (Weekly). Depending
      on your organization's needs, one may be preferred over the other. See the links below for
      more information and recommendations about the release lines.
    </p>
    <section>
      ...
      <div>
        <div style={{ display: "flex", justifyContent: "space-between" }}>
          <div style={{ width: "50%" }}>
            <h3>Stable (LTS)</h3>
            <p>
              Long-Term Support (LTS) release baselines are chosen every 12 weeks from the stream of
              regular releases. Every 4 weeks, we release stable releases which include bug and
              security fix backports. <a href="/changelog-lts"> Learn more…</a>
            </p>
            <p>
          ...
          <div style={{ width: "50%" }}>
            ...
            <p>
              This release line delivers bug fixes and new features rapidly to users and plugin
    ...
    <section>
      ...
      <p>
        Jenkins is distributed as WAR files, native packages, installers, and Docker images. Follow
      ...
      <ol>
        <li>
          ...
          <strong>
            <a href="/doc/book/installing/#prerequisites">Hardware and Software requirements</a>
          </strong>{" "}
      ...
      <div className={downloadTable}>
        <div style={{ width: "45%" }}>
          ...
          <ul className={listGroup}>
            ...
            <li>
              <a rel="noreferrer" target="_blank" href="https://hub.docker.com/r/jenkins/jenkins">
                Docker
              </a>
            </li>
            <li>
            ...
            <li>
              <a rel="noreferrer" target="_blank" href="https://pkg.jenkins.io/debian-stable/">
                Ubuntu/Debian
              </a>
            </li>
            <li>
              <a rel="noreferrer" target="_blank" href="https://pkg.jenkins.io/redhat-stable/">
            ...
            <li>
              <a rel="noreferrer" target="_blank" href="https://pkg.jenkins.io/opensuse-stable/">
                openSUSE
              </a>
            </li>
            <li>
        ...
        <div style={{ width: "45%" }}>
          ...
          <ul className={listGroup}>
            ...
            <li>
              <a rel="noreferrer" target="_blank" href="https://pkg.jenkins.io/debian/">
                Ubuntu/Debian
              </a>
            </li>
            <li>
              <a rel="noreferrer" target="_blank" href="https://pkg.jenkins.io/redhat/">
                Red Hat/Fedora/Alma/Rocky/CentOS
              </a>
            </li>
            <li>
            ...
            <li>
              <a rel="noreferrer" target="_blank" href="https://pkg.jenkins.io/opensuse/">
                openSUSE
              </a>
            </li>
            <li>
    ...
    <section>
      ...
      <p style={{ marginBottom: "1cm" }}>
        Many public cloud vendors provide their own Jenkins installation guides and packages. The
        guides provide instructions to deploy, maintain, and upgrade on the specific public cloud.
        Such guides may be used to quickly deploy Jenkins and, in many cases, to get an instance
        preconfigured to be used within the public cloud (e.g. bundled plugins, integrations with
        public cloud services, etc.).
      </p>
      <div>
        <div className={vendorsList}>
          ...
          <div className={vendors}>
            ...
            <p>
              ...
              <a className="item" href="https://bitnami.com/stack/jenkins/cloud/azure">
                {" "}
                Azure,{" "}
              </a>{" "}
              and{" "}
              <a className="item" href="https://bitnami.com/stack/jenkins/cloud/google">
                {" "}
                Google Cloud
              </a>
            </p>
