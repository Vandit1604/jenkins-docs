...
if (process.env.BUILD_STAGE === "develop") {
  ...
  exports.onClientEntry = function (a, pluginOptions) {
    ...
    var omit = typeof pluginOptions.omitGoogleFont !== "undefined" ? pluginOptions.omitGoogleFont : false;
    ...
    if (typography.options.googleFonts.length > 0 && !omit) {
      if (typeof document !== "undefined") {
        ...
        var linkElement = doc.head.firstChild;
        // Add custom identifier
        linkElement.setAttribute("data-gatsby-typography", "true");
        var head = document.getElementsByTagName("head")[0];
        var elem = document.querySelector("[data-gatsby-typography]");
        // Remove old <link /> tag
        if (elem) {
          elem.remove();
        }
